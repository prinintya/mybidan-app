...
<div class="justify-content-center">
	<h4 class="content-title mb-1" style="padding-top: 2.5cm; padding-left:1.5cm">Tambah Persalinan</h4>
    ...
    <div class="container-fluid mg-t-20">
				...
				<div class="row row-sm">
					...
					<div class="col-xl-12">
					    ...
					    @endif
                        <form method="post" action="/store_persalinan">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="laporanPersalinan">Laporan Persalinan</label>
                                <input type="text" name="laporanPersalinan" class="form-control" id="laporanPersalinan" value="{{ old('laporanPersalinan') }}">
                            </div>
